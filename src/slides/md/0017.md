...
- ファイルをリネーム
$ mv hello-world.yml docker-compose.yaml
...
「nnnnnnnnnnnn.dkr.ecr.ap-northeast-1.amazonaws.com/tutorial/repo:latest」がタグ名
コンテナ数分実行する
