...
![ECS cluster create](/slides/img/0018/ecs_cluster_create.png)<!-- .element: class="img_50" -->
...
-COPY index.php /var/www/html/
+RUN git clone https://github.com/kaotil/kaotil.com.git /var/www/kaotil.com
...
![ECS phpinfo](/slides/img/0018/ecs_task_new_revision_volume.png)<!-- .element: class="img_50" -->
...
![ECS phpinfo](/slides/img/0018/ecs_task_new_revision_volume_mount.png)<!-- .element: class="img_70" -->



#### nginxコンテナのvolume_from追加

![ECS phpinfo](/slides/img/0018/ecs_task_new_revision_volume_from.png)<!-- .element: class="img_70" -->
